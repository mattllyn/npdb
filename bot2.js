...
var esBot = {
        ...
        roomSettings: {
            ...
            motdEnabled: false,
            motdInterval: 5,
            motd: "You can get rewards from advertising and promoting our server!",                
            filterChat: true,
            etaRestriction: false,
            welcome: true,
            opLink: null,
            rulesLink: "https://docs.google.com/document/d/1Lx8OgV3owrCuMzQgECA6gvsHIlzqaEMpRBJV0TR7c9k/edit",
            themeLink: null,
            fbLink: null,
            youtubeLink: null,
            twitterLink: "http://twitter.com/DubMunity",
            intervalMessages: [],
            messageInterval: 5,
            songstats: true,                      
        },        
        ...
        chatUtilities: {        
            chatFilter: function(chat){
                ...
                if(msg.indexOf('http://adf.ly/') > -1){
                    API.moderateDeleteChat(chat.chatID);
                    API.sendChat('/me @' + chat.from + ', please change your autowoot program. We suggest TastyPlug, chrome only: https://chrome.google.com/webstore/detail/tastyplug/faccgibalfdoihmenknhpfhldkmgaang?hl=en');
                    return true;
                }                    
            ...
            commandCheck: function(chat){
                ...
                switch(cmd){
                    ...
                    case '!twitter':            esBot.commands.twitterCommand.functionality(chat, '!twitter');                      executed = true; break;
        ...
        startup: function(){
            var u = API.getUser();
            if(u.permission < 0) return API.chatLog("Only bouncers and up can run a bot.");
                ...
                twitterCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(typeof esBot.roomSettings.twitterLink === "string")
                                        API.sendChat("/me Please visit our twitter: " + esBot.roomSettings.twitterLink);
                                };                              
                        },
                },
